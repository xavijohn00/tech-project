...
<div class="container">
    ...
    <div class="card">
        ...
        <table>
            <tr><th>Student</th><th>Brooder</th><th>Status</th><th>Activity</th><th>Light</th><th>Action</th></tr>
            <?php foreach ($students as $s): ?>
            <?php
                $has_brooder = !empty($s["brooder_id"]);
                $needs_attention = !$has_brooder;
            ...
            <tr class="student-row" data-filter="<?php echo $row_filter; ?>" data-search="<?php echo htmlspecialchars($search_text); ?>">
                ...
                <td><?php echo $s["activity"]; ?>%</td>
                <td><?php echo $s["light_level"]; ?>%</td>
            ...
            <tr class="student-detail" style="display:none;"><td colspan="6">
                <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap:14px;">
                    ...
                    <div><strong style="font-size:1rem;">Light Level</strong><?php echo $s["light_level"]; ?>%</div>
                    <div><strong style="font-size:1rem;">Mock Update</strong><?php echo htmlspecialchars($s["last_seen"]); ?></div>
                </div>
            </td></tr>
            <?php endforeach; ?>
        </table>
